...
**Особенности:**
- 🎬 Управление видео, изображениями, PDF, PPTX
...
### Для разработчиков:
- [🏗️ Roadmap рефакторинга](docs/REFACTORING_ROADMAP.md)
- [✅ Checklist рефакторинга](docs/REFACTORING_CHECKLIST.md)
- [📁 Структура после рефакторинга](docs/PROJECT_STRUCTURE_AFTER_REFACTORING.md)
- [📊 Финальная структура](docs/PROJECT_STRUCTURE_FINAL.md)

### Отчеты:
- [Backend рефакторинг](docs/reports/backend/)
- [Frontend рефакторинг](docs/reports/frontend/)
- [Android фиксы](docs/reports/android/)
- [Общие фиксы](docs/reports/fixes/)
